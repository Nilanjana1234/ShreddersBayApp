...
if($_REQUEST['action']=='insert'){		
				...
				if($fs){
				    $query = "INSERT INTO tbl_prodAuction( p_name, sub_name, weight, price, file, status) VALUES ('".$p_name."','".$sub_name."','".$weight."','".$price."','".$file."','1')";
...
{
	 $query = "SELECT * FROM tbl_prodAuction";
...
if($_REQUEST['action']=='select_id')
{
	$prod_id=$_POST['prod_id'];
	 $query = "SELECT * FROM tbl_prodAuction WHERE prod_id='".$prod_id."'";
	 $res = mysqli_query($con, $query);
...
if($_REQUEST['action']=='edit')
{
	$p_name = $_POST['p_name'];
         ...
         $location = "uploads/";
				...
				if($fs){
	$query = "UPDATE tbl_prodAuction SET  p_name = '$p_name', sub_name = '".$sub_name."', weight = '".$weight."', price = '".$price."', file = '".$file."' WHERE prod_id='".$_POST['prod_id']."'";
//	echo $query;
...
{
	$query = "DELETE from tbl_prodAuction  WHERE prod_id='".$_POST['prod_id']."'";
	if(mysqli_query($con, $query))
	{
