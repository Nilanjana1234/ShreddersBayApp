...
if($_REQUEST['action']=='insert'){	
				...
				$query = "INSERT INTO tbl_auction(user_id, prod_id, total_wieght, total_price, filename, dealer_id, addr_id,  booking_date, schedule_date,start_date,end_date,status) VALUES ('$user_id', '$prod_id', '$total_weight', '$total_price', '$file_name','0',  '$addr_id', now(), '$schedule_date', '$start_date', '$end_date','1')";
...
{
// 	 $query = "SELECT * FROM tbl_orders as o left join tbl_users as user on user.id=o.user_id left join tbl_address as addr on addr.addr_id=o.addr_id left join tbl_products as p on p.p_id=o.prod_id WHERE o.status = 1 order by o.booking_id  DESC";
    $query = "SELECT * FROM tbl_auction as o left join tbl_users as user on user.id=o.user_id left join tbl_address as addr on addr.addr_id=o.addr_id left join tbl_country as c on c.country_id=addr.country_id left join tbl_state as s on s.state_id=addr.state_id left join tbl_city as city on city.city_id=addr.city_id left join tbl_area as area on area.area_id=addr.area_id left join tbl_products as p on p.p_id=o.prod_id WHERE o.status = 1 order by o.auction_id  DESC";
// echo $query;
// exit();
	 $res = mysqli_query($con, $query);
	  if($res){
...
{
	 $query = "SELECT * FROM tbl_orders as o left join tbl_users as user on user.id=o.user_id left join tbl_address as addr on addr.addr_id=o.addr_id left join tbl_products as p on p.p_id=o.prod_id WHERE o.status = 4 order by o.auction_id  DESC";
	 $res = mysqli_query($con, $query);
	 if($res){
...
{
	 $query = "SELECT * FROM tbl_orders as o left join tbl_users as user on user.id=o.user_id left join tbl_address as addr on addr.addr_id=o.addr_id left join tbl_products as p on p.p_id=o.prod_id WHERE o.status = 0 order by o.auction_id  DESC";
	 $res = mysqli_query($con, $query);
	 if($res){
...
{
	 $query = "SELECT * FROM tbl_orders as o left join tbl_products as p on p.p_id=o.prod_id left join tbl_users as users on o.user_id=users.id left join tbl_address as addr on addr.addr_id=o.addr_id  where o.auction_id='".$_POST['auction_id']."' and o.status=0";
	 $res = mysqli_query($con, $query);
	  if($res){
...
{
	 $query = "SELECT * FROM tbl_orders as o left join tbl_products as p on p.p_id=o.prod_id left join tbl_users as users on o.user_id=users.id left join tbl_address as addr on addr.addr_id=o.addr_id  where o.auction_id='".$_POST['auction_id']."' and o.status=4";
	 //echo $query;
	 $res = mysqli_query($con, $query);
...
{
	 $query = "SELECT * FROM tbl_auction as o left join tbl_auctionusers as user on user.id=o.user_id left join tbl_address as addr on addr.addr_id=o.addr_id left join tbl_products as p on p.p_id=o.prod_id WHERE o.dealer_id ='".$_POST['user_id']."' and o.status = 2 order by o.auction_id  DESC";
...
{
	 $query = "SELECT * FROM tbl_auction as o left join tbl_auctionusers as user on user.id=o.user_id left join tbl_address as addr on addr.addr_id=o.addr_id left join tbl_products as p on p.p_id=o.prod_id WHERE o.status = 1 && o.dealer_id ='".$_POST['user_id']."' order by o.auction_id  DESC";
	 $res = mysqli_query($con, $query);
	 if($res){
...
{
	 $query = "SELECT * FROM tbl_auction as o left join tbl_auctionusers as user on user.id=o.user_id left join tbl_address as addr on addr.addr_id=o.addr_id left join tbl_products as p on p.p_id=o.prod_id WHERE o.status = 4 && o.dealer_id ='".$_POST['user_id']."' order by o.auction_id  DESC";
	 $res = mysqli_query($con, $query);
	if($res){
...
if($_REQUEST['action']=='cancel')
{
	...
	$query = "UPDATE tbl_auction SET status = '1', canceled_at = now() WHERE auction_id='".$auction_id."'";
// 	echo $query;
// 	exit();
	if(mysqli_query($con, $query))
	{
...
if($_REQUEST['action']=='complete')
{
	...
	$query = "UPDATE tbl_auction SET status = '4', completed_at = now() WHERE auction_id='".$auction_id."'";
